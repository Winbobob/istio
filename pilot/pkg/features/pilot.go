...
var (
	...
	RemoteClusterSecretPath = env.Register("PILOT_REMOTE_CLUSTER_SECRET_PATH", "",
		"If set, istiod reads remote cluster secrets from this local directory instead of Kubernetes secrets.").Get()
